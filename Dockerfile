...
RUN wget -O /tmp/firefox-109.0.1.tar.bz2 "https://download-installer.cdn.mozilla.net/pub/firefox/releases/109.0.1/linux-x86_64/en-US/firefox-109.0.1.tar.bz2" \
    && tar -xvf /tmp/firefox-109.0.1.tar.bz2 \
    && mv firefox /opt \
